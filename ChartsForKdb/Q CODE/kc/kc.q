...
.kc.uf:"j"$200*(10 xexp 6) /limit update frequency of charts in nanoseconds (500*10^6)

.z.ws:{neg[.z.w] -8!value -9!x;} /set WebSocket function to run
.z.vs:{y; if[98h=(type (eval x));.kc.updateChart[x]] } /copy the if statement to your own .z.vs if custom one is implemented
.z.pc:{ .kc.removeFromSubscriberList[x] } /copy the function call to your own .z.pc if custom one is implemented
