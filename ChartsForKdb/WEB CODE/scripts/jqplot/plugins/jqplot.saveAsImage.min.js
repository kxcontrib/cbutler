/**
 * NOT a standard plugin of jqPlot. This is an extra plugin I am adding
 * to allow users to have the option to download the chart which they have
 * just seen as an image, specifically as a PNG.
 *
 * I have not written this code, although I have slightly changed it.
 * Original location: https://bitbucket.org/cleonello/jqplot/issue/14/export-capabilities#comment-554274 (21st April 2012)
 *
 * The image will be shown on screen and can be drag and dropped, copied and pasted or 'Save As...'
 * To get the button to show, add $.jqplot._noToImageButton = false and a button will show below the graph
 */
